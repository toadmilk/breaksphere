...
export const EditProfileModal: React.FC<ModalProps> = ({ title, isOpen, onClose, profile }) => {
  ...
  return isOpen ? (
    <div className={'fixed inset-0 bg-opacity-30 backdrop-blur-sm flex justify-center z-50 items-center dark:text-white py-2'}>
    <div ref={outsideRef} className="fixed z-40" onClick={handleCloseOnOverlay} />
    <div className="max-w-md bg-white dark:bg-neutral-900 rounded-lg shadow-xl w-full h-[700px] overflow-y-scroll hide-scrollbar">
